...
public class Repaso2Venta {
    ...
    public static void buscarProducto(Producto[] inventario, String codigoBuscado) {
        ...
        for (int i = 0; i < inventario.length; i++) {
            Producto producto = inventario[i];
            if (producto != null && producto.codigoDeBarras.equalsIgnoreCase(codigoBuscado)) {
             System.out.println("Sew encontro el producto:");
                System.out.println(producto); // saca el tostring
                buscado = true;
